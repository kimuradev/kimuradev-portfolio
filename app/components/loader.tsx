...
export function Loader() {
    return (
        <div className="w-screen h-screen flex items-center justify-center absolute top-0 bottom-0 left-0 right-0 bg-secondary loader z-100">
            <svg id="rounded-logo-loader" width="171" height="171" viewBox="0 0 171 171"
                xmlns="http://www.w3.org/2000/svg">
                <circle cx="85.5" cy="85.5" r="82.5" fill="var(--fill-secondary)" stroke="var(--stroke-primary)" stroke-width="2" stroke-linecap="round" />
                <path
                    ...
                    stroke="var(--stroke-primary)" stroke-width="2" stroke-linecap="round"/>
                <path
