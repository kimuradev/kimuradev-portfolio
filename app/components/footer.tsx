      ...
      <ul className="flex gap-2">
        <li className="opacity-0 transition-fadein"
          ...
          <Link href="https://www.linkedin.com/in/kimuradev/" rel="noopener noreferrer" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="#0a66c2" className="mercado-match" width="30" height="30" focusable="false">
        ...
        <li className="opacity-0 transition-fadein"
          ...
          <Link href="https://github.com/kimuradev" rel="noopener noreferrer" target="_blank">
            <svg height="30" aria-hidden="true" viewBox="0 0 24 24" version="1.1" width="30" data-view-component="true" className="octicon octicon-mark-github v-align-middle color-fg-default">
